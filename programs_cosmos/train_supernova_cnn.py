...
TRAINING DATA (verified by visual inspection):
  IDs 1 through 53131:
    - 7 confirmed supernovae: 9748, 19931, 25141, 27350, 39020, 52864, 53669
    - ALL other objects in this range: confirmed NOT supernovae
  This gives ~53,000 verified negatives + 7 verified positives.

  Additional artificial supernovae are generated by injecting
  Gaussian point sources near the galaxy center.

  All 23 known SN across the full dataset are used as positives.
...
# Verified ground truth: IDs 1-53131 visually inspected
VERIFIED_MAX_ID = 53131
VERIFIED_SN_IDS = {"9748", "19931", "25141", "27350", "39020", "52864", "53669"}
...
def main():
    ...
    print(f"Known SN found: {len(known_sn_objects)}/{len(KNOWN_SUPERNOVAE_SET)}")
    ...
    # Add all 23 known SN as additional positives
